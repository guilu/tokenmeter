...
export function OverviewMetricsSection({ status, data, error }: OverviewMetricsSectionProps) {
      ...
      <div className="mt-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div className="rounded-2xl bg-card/20 p-5 animate-pulse" key={i}>
              <div className="h-4 w-24 rounded bg-text/10 mb-3" />
              <div className="h-8 w-16 rounded bg-text/10" />
            </div>
          ))}
        </div>
        <div className="mt-4 rounded-2xl bg-card/20 p-5 animate-pulse">
  ...
  return (
    <div className="mt-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <article className="rounded-2xl bg-card/20 p-5 shadow-2xl shadow-bg/20">
      ...
      <div className="mt-4 rounded-2xl bg-card/20 p-5 shadow-2xl shadow-bg/20">
